...
if __name__ == "__main__":
    ...
    scenarios = (pd.merge(inflows_df.rename(columns = {"value":'inflows'}).drop(columns = 'indicator_type').loc[lambda d: d.year != 2023],
                         outflows_df.rename(columns = {"value":'outflows'}).drop(columns = 'indicator_type'),
                         how="left")
